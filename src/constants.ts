...
export enum USE_CASES_LOGGER {
  ...
  ADD_COUNTDOWN_USE_CASE_LOGGER = "ADD_COUNTDOWN_USE_CASE_LOGGER",
  GET_ALL_COUNTDOWNS_USE_CASE_LOGGER = "GET_ALL_COUNTDOWNS_USE_CASE_LOGGER",
}

// REPOSITORIES
export const EXAMPLE_REPOSITORY = "EXAMPLE_REPOSITORY";
export const COUNTDOWN_REPOSITORY = "COUNTDOWN_REPOSITORY";
